                      ...
                      <div class="table table-striped table-valign-middle mb-0">
                          <table class="table table-hover mb-0">
                              ...
                              <tr>
                                ...
                                <td>
                                    <a href="?update={{$category['id']}}" class="btn btn-default btn-icons"><i class="fa fa-edit"></i></a>
                                    <a href="?delete={{$category['id']}}" class="btn btn-default btn-icons"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                              @endforeach
